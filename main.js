...
const {
    ...
    proto,
    jidNormalizedUser,
    PHONENUMBER_MCC: _PHONENUMBER_MCC,
    Browsers
} = baileys

// Fallback untuk PHONENUMBER_MCC jika tidak ada di baileys
const PHONENUMBER_MCC = _PHONENUMBER_MCC || {
    ...
    '234': 'NG', '254': 'KE', '255': 'TZ', '256': 'UG', '880': 'BD',
    '852': 'HK', '886': 'TW', '960': 'MV', '966': 'SA', '971': 'AE'
}
...
global.db = new Low(
    ...
    defaultData  // Tambahkan default data sebagai parameter kedua
)
